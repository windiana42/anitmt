...
class indexchunk : public chunk {
  public:
	indexchunk(chunkstream *, char *name, int peer );
  private:
	char tname[4];
	virtual void WRITE();
};

class index_item_chunk : public chunk {
  public:
	index_item_chunk(chunkstream *cs, int peer, char *dname, 
