...
#ifndef _ANIVISION_OBJDESC_CURVE_LSPLINE_H_
#define _ANIVISION_OBJDESC_CURVE_LSPLINE_H_

#include <objdesc/curve_splinebase.h>
#include <numerics/spline/lspline.h>


namespace NUM
{

class CurveFunction_LSpline : public CurveFunction_Spline_Base
{
	private:
		// The actual spline; set up by Create(). 
		LinearSpline *lspline;
		
	public:
		CurveFunction_LSpline();
		~CurveFunction_LSpline();
		...
		//[default] int SetAddPoints(const char *val);
...
#endif  /* _ANIVISION_OBJDESC_CURVE_LSPLINE_H_ */
